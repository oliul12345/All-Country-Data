      ...
      <div className=" bg-slate-100/70 px-6 py-4 mx-auto rounded-2xl space-y-6 shadow-md">
        ...
        <div className="space-y-2">
          ...
          <h2 className="text-slate-800 font-medium md:text-xl sm:text-lg ">
            Country Name : <span className="text-blue-600">{name.common}</span>
          </h2>
          <h2 className="text-slate-800 font-medium md:text-xl sm:text-lg ">
            Religion is : <span className="text-blue-600">{region}</span>
          </h2>
          {/* rating  */}
        ...
        <div className="mt-5 flex justify-between items-center font-medium">
          <button
            onClick={handleVisit}
            className="bg-red-500 font-bold p-3 rounded-xl text-white"
          >
            {visit ? "visited" : "visit"}
          </button>
          <button
            onClick={() => handleSingleVisitCountry(country)}
        ...
        <div>
          <p className="bg-orange-300 p-2 font-bold">
            {visit
              ? "I visit this country pls next one"
